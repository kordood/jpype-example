...
class InfoflowProblem(AbstractInfoflowProblem):
    ...
    def __init__(self, manager, zeroValue, ruleManagerFactory):
        ...
        self.zeroValue = self.createZeroValue() if zeroValue == null else zeroValue
    ...
    def createFlowFunctionsFactory():
        return FlowFunctions()
            ...
            class NotifyingNormalFlowFunction(SolverNormalFlowFunction):
                ...
                abstract Set<Abstraction> computeTargetsInternal(Abstraction d1, Abstraction source)
             ...
             */
            void addTaintViaStmt(final Abstraction d1, final AssignStmt assignStmt, Abstraction source,
             ...
             */
            boolean hasValidCallees(Unit call):
            ...
            Set<Abstraction> createNewTaintOnAssignment(final AssignStmt assignStmt, final Value[] rightVals,
            ...
            @Override
            FlowFunction<Abstraction> getNormalFlowFunction(final Unit src, final Unit dest):
                // Get the call site
            ...
            @Override
            FlowFunction<Abstraction> getCallFlowFunction(final Unit src, final SootMethod dest):
                if (!dest.isConcrete()):
            ...
            @Override
            FlowFunction<Abstraction> getReturnFlowFunction(final Unit callSite, final SootMethod callee,
            ...
            @Override
            FlowFunction<Abstraction> getCallToReturnFlowFunction(final Unit call, final Unit returnSite):
             ...
             */
            Set<AccessPath> mapAccessPathToCallee(final SootMethod callee, final InvokeExpr ie,
